...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    >
        ...
        @else
            <div class="w-full flex flex-col h-[140px] justify-center items-center fi-fo-repeater-item rounded-xl bg-white gap-2 shadow-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10">
                <x-filament::icon
